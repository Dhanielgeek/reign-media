...
export const services = [
  ...
  {
    number: "02",
    title: "Web Designs/Web Applications",
    description:
      "Print, digital design, and custom web applications — designed and built end to end, from first sketch to a fully functioning site.",
    image: ImageSix
  },
  {
    number: "03",
...
export const portfolioItems = [
  ...
  { id: 6, category: "Web Designs/Web Applications", title: "U-GENE Aesthetics", tone: "from-[#0b0b0c] to-[#8a6d2e]", image: ImageSix },
];
